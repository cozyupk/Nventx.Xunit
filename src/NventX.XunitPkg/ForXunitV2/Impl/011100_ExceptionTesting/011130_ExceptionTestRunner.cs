...
namespace NventX.Xunit.ExceptionTesting
{
    namespace NventX.Xunit.ExceptionTesting
    {
        ...
        /// </summary>
        /// <remarks>
        /// Initializes a new instance of the <see cref="ExceptionTestRunner"/> class.
        /// </remarks>
        internal class ExceptionTestRunner : XunitTestRunner
        {
            public ExceptionTestRunner(ITest test, IMessageBus messageBus, Type testClass, object[] constructorArguments,
