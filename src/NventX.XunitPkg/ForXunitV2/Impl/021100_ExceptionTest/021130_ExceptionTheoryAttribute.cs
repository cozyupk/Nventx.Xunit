...
namespace NventX.Xunit.ExceptionTest
{
    ...
    /// </summary>
    [XunitTestCaseDiscoverer("NventX.Xunit.ExceptionTheory.ExceptionTheoryDiscoverer", "NventX.Xunit.ForXunitV2")]
    [AttributeUsage(AttributeTargets.Method, AllowMultiple = false)]
    public class ExceptionTheoryAttribute : TheoryAttribute
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExceptionFactAttribute"/> class.
        /// </summary>
        public ExceptionTheoryAttribute(Type? expectedExceptionType = null, string? expectedMessageSubstring = null)
        {
