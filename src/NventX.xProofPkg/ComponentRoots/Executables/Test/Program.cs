...
namespace NventX.xProof.SupportingXunit.Test
{
    ...
    public static class XProofGenerator
    {
        ...
        public static string GenerateFrom(Type assertType)
        {
            ...
            sb.AppendLine("using NventX.xProof.BaseProofLibrary.Proofs;");
            sb.AppendLine("using Xunit;");
            sb.AppendLine();
            sb.AppendLine("namespace NventX.xProof.SupportingXunit.Test {");
