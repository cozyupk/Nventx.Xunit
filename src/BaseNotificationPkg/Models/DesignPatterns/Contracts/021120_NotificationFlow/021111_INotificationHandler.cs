...
namespace Cozyupk.Shadow.Flow.BaseNotificationPkg.Models.Contracts.NotificationFlow
{
    ...
    public interface INotificationHandler<out TTarget>
    {
        ...
        /// Only a single delegate may be assigned; setting this property more than once is expected to throw an exception.
        /// </summary>
        /// <remarks>
        ...
        /// Implementations should throw if an attempt is made to assign the handler multiple times.
        /// </remarks>
